...
def detect_image(Yolo, image_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors='', XML = False, filename =  str(int(time.time()))):
    ...
    # convert yolo object detection to XML file
    if XML:
        CreateXMLfile(os.path.dirname(image_path), filename, original_image, bboxes, read_class_names(CLASSES))
