...
YOLO_CUSTOM_WEIGHTS         = "checkpoints/yolov4_custom" # used in evaluate_mAP.py and custom model detection, if not using leave False
...
# TEST options
TEST_ANNOT_PATH             = "model_data/class_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
